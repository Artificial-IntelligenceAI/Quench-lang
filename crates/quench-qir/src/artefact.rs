...
fn host_code(host: Host) -> u8 {
    match host {
        ...
        Host::FloatSlow => 45,
        Host::FloatPower => 46,
        Host::InputAllReplaces => 60,
        Host::InputLineReplaces => 61,
        Host::InputMore => 62,
        Host::InputArguments => 63,
        Host::InputAllStops => 64,
        Host::InputLineStops => 65,
        Host::TextSliceClusters => 53,
        Host::TextSliceLetters => 54,
        Host::TextFindClusters => 55,
        Host::TextFindLetters => 56,
        Host::TextHas => 57,
        Host::TextSplit => 58,
        Host::TextTrim => 59,
        Host::TextReads => 47,
...
impl<'a> Reader<'a> {
    ...
    fn host(&mut self) -> Result<Host, Wrong> {
        Ok(match self.byte()? {
            ...
            46 => Host::FloatPower,
            47 => Host::TextReads,
            60 => Host::InputAllReplaces,
            61 => Host::InputLineReplaces,
            62 => Host::InputMore,
            63 => Host::InputArguments,
            64 => Host::InputAllStops,
            65 => Host::InputLineStops,
            53 => Host::TextSliceClusters,
            54 => Host::TextSliceLetters,
            55 => Host::TextFindClusters,
            56 => Host::TextFindLetters,
            57 => Host::TextHas,
            58 => Host::TextSplit,
            59 => Host::TextTrim,
            48 => Host::TextAsWhole,
